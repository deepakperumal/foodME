'use strict';
foodMeApp.directive('sliderRange', ['$document',function($document) {
  ...
  return {
      template: '<div class="slider horizontal">'+
                  '<div class="range"></div>'+
                  '<span class="handle min" ng-mousedown="mouseDownMin($event)"></span>'+
                  '<span class="handle max" ng-mousedown="mouseDownMax($event)"></span>'+
                '</div>',
      replace: true,
      restrict: 'E',
      scope:{
